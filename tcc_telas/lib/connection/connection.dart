...
class Connection {
  static Future<List<Cardapio>> getCardapio(String data) async {
    var url = Uri.parse("http://143.106.241.174:3000/api/cardapio/${data}");
  ...
  static Future<String> getSaldo2(String ra, String senha) async {
    var url = Uri.parse("http://143.106.241.174:3000/api/saldo");
  ...
  static Future<String> getSaldo(String ra, String senha) async {
    var url = Uri.parse("http://143.106.241.174:3000/api/saldo/${ra}/${senha}");
